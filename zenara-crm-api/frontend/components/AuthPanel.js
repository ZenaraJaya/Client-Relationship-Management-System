...
const BACKGROUND_BUBBLES = [
  {
    ...
    drift: '44px',
    opacity: 0.96,
    tint: 'rgba(37, 99, 235, 0.58)',
    edge: 'rgba(191, 219, 254, 0.88)',
    shadow: 'rgba(30, 64, 175, 0.36)',
    blur: '0px',
  },
  {
    size: '112px',
    ...
    drift: '20px',
    opacity: 0.78,
    tint: 'rgba(14, 116, 144, 0.54)',
    edge: 'rgba(186, 230, 253, 0.82)',
  ...
  },
  {
    ...
    drift: '-30px',
    opacity: 0.82,
    tint: 'rgba(29, 78, 216, 0.56)',
    edge: 'rgba(191, 219, 254, 0.86)',
  ...
  },
  {
    ...
    drift: '24px',
    opacity: 0.76,
    tint: 'rgba(30, 64, 175, 0.52)',
    edge: 'rgba(191, 219, 254, 0.8)',
  ...
  },
  {
    ...
    drift: '-36px',
    opacity: 0.88,
    tint: 'rgba(55, 48, 163, 0.56)',
    edge: 'rgba(199, 210, 254, 0.84)',
  ...
  },
  {
    ...
    drift: '18px',
    opacity: 0.72,
    tint: 'rgba(3, 105, 161, 0.5)',
    edge: 'rgba(186, 230, 253, 0.8)',
  ...
  },
  {
    ...
    drift: '-26px',
    opacity: 0.82,
    tint: 'rgba(30, 64, 175, 0.54)',
    edge: 'rgba(191, 219, 254, 0.84)',
    shadow: 'rgba(30, 58, 138, 0.3)',
    blur: '0px',
  },
]
