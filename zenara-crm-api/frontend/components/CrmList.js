...
export default function CrmList({
  ...
  return (
    <div style={{ width: '100%', overflowX: 'visible', overflowY: 'hidden', flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
      <table style={{ borderCollapse: 'collapse', width: '100%', fontSize: '12px', tableLayout: 'fixed', height: '80%' }}>
        <colgroup>
          <col style={{ width: '3%' }} />
          <col style={{ width: '4%' }} />
          <col style={{ width: '15%' }} />
        ...
        <thead>
          <tr style={{ background: 'var(--table-head-bg)', borderBottom: '2px solid var(--table-head-border)' }}>
            <th style={{ padding: '10px 8px', whiteSpace: 'nowrap' }}>
              {canDelete ? (
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <div style={{
                        ...
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                          stroke={isExpanded ? 'var(--table-expand-icon-stroke)' : 'var(--table-row-number)'}
                  ...
                  <td style={{ padding: '10px 8px' }} onClick={(e) => e.stopPropagation()}>
                    <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                      ...
                      {!canEdit && !canDelete && (
                        <span style={{ fontSize: '11px', fontWeight: 600, color: 'var(--table-viewonly-text)' }}>View only</span>
                      )}
                    </div>
                  </td>
                </tr>
                  ...
                  <tr style={{ background: 'var(--table-row-expanded-bg)', borderBottom: '1px solid var(--table-head-border)' }}>
                    <td colSpan={expandedDetailsColSpan} style={{ padding: '24px 40px 32px 60px' }}>
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px' }}>
                        ...
                        {/* Strategy Card */}
                        <div style={{ background: 'var(--table-expanded-card-bg)', padding: '20px', borderRadius: '12px', boxShadow: 'var(--table-expanded-card-shadow)', border: '1px solid var(--table-expanded-card-border)', display: 'flex', flexDirection: 'column' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                            <div style={{ background: 'var(--table-expand-icon-bg)', padding: 6, borderRadius: 8 }}>
